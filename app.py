...
with st.sidebar:
    ...
    st.write("✅ Important Notes Extraction")
    ...
    st.caption("AI-Powered Multi-PDF Conversational RAG Assistant")
...
if uploaded_files:
    ...
    important_notes_button = st.button(
        "📌 Generate Important Notes"
    )

    if important_notes_button:

        notes_prompt = f"""
        Read the following educational content
        and extract the most important notes.
        ...
        st.write(notes_response.content)
